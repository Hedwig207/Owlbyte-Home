...
export const PRODUCTS: Product[] = [
  {
    ...
    name: 'Observatory',
    tagline: '数据观测台',
    description: '为夜间值班工程师打造的多源数据观测与异常感知系统。支持 Prometheus / OpenTelemetry / ClickHouse 等 12+ 数据源的统一接入，以毫秒级流式处理聚合海量指标；可组合的告警管线内置 30+ 降噪规则与「观察哨值守模式」，在最安静的时段也不会漏掉真正需要你起身处理的信号。',
    href: '/project/observatory',
    status: 'PREVIEW',
    span: 'tall',
    accent: 'amber',
    symbol: 'Ob',
  },
  {
    ...
    name: 'Lumen',
    tagline: '夜间专注引擎',
    description: '基于个体行为建模的专注力调度器。通过学习你的作息节律与深度工作规律，在你最敏锐的时段自动「打开灯」——拦截通知、屏蔽干扰源、切换至低蓝光配色；在最深的夜里则收束背景噪声，提醒你何时该合上屏幕，走向黎明。',
    href: '/project/lumen',
    status: 'PREVIEW',
    span: 'regular',
    accent: 'moon',
  ...
  },
  {
    ...
    name: 'Parchment',
    tagline: '可信赖的发布平台',
    description: '为技术写作、研究笔记与长篇思想内容设计的版本化发布系统。每一次修订都像刻在羊皮纸上那样可追溯、可引用、可永久存档；支持 Git 存储后端、IPFS 可选归档与自托管部署，让你写下来的每一个字都属于你，也属于任何愿意花时间阅读它的未来读者。',
    href: '/project/parchment',
    status: 'PREVIEW',
    span: 'wide',
    accent: 'amber',
    symbol: 'Pa',
